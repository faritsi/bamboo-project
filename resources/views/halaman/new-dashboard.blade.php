                        ...
                        <div class="carousel-track">
                            <div class="carousel-slide">
                                <div id="carousel-image">
                                    <img src="img/bambu/bambu_16.jpeg" alt="Product 1">
                                </div>
                                <p id="nama-produk">Meja Bambu Alami</p>
                                <p id="desc-produk">Meja bambu yang kokoh dan tahan lama, dibuat dari bambu yang diproses dengan teknik ramah lingkungan.</p>
                                <p id="harga-produk">Rp. 1.500.000</p>
                            </div>
                            <div class="carousel-slide">
                                <div id="carousel-image">
                                    <img src="img/bambu/bambu_17.jpeg" alt="Product 2">
                                </div>
                                <p id="nama-produk">Kursi Bambu Minimalis</p>
                                <p id="desc-produk">Kursi bambu dengan desain minimalis yang nyaman dan cocok untuk segala jenis ruangan.</p>
                                <p id="harga-produk">Rp. 750.000</p>
                            </div>
                            <div class="carousel-slide">
                                <div id="carousel-image">
                                    <img src="img/bambu/bambu_16.jpeg" alt="Product 3">
                                </div>
                                <p id="nama-produk">Rak Bambu Serbaguna</p>
                                <p id="desc-produk">Rak bambu serbaguna yang elegan, cocok untuk menyimpan berbagai macam barang.</p>
                                <p id="harga-produk">Rp. 850.000</p>
                            </div>
                            <div class="carousel-slide">
                                <div id="carousel-image">
                                    <img src="img/bambu/bambu_16.jpeg" alt="Product 3">
            ...
            <div id="content-activity">
                ...
                <div class="carousel-act">
                    <div class="carousel-track-act">
                      <div class="carousel-slide-act"><img src="img/bambu/bambu_16.jpeg" alt="Kegiatan 1"></div>
                      <div class="carousel-slide-act"><img src="img/bambu/bambu_16.jpeg" alt="Kegiatan 2"></div>
                      <div class="carousel-slide-act"><img src="img/bambu/bambu_16.jpeg" alt="Kegiatan 3"></div>
                      <div class="carousel-slide-act"><img src="img/bambu/bambu_16.jpeg" alt="Kegiatan 4"></div>
                    </div>
                </div>
            </div>
                ...
                <div id="container-so">
                    ...
                    <div id="profile-so">
                        <div class="profile-card">
                            <img src="img/bambu/bambu_11.jpeg" alt="Image 1">
                            <p class="nama-pimpinan">John Doe</p>
                            <p class="jabatan-pimpinan">CEO</p>
                            <p class="desc-pimpinan">John Doe has been leading the company for over a decade with a focus on innovation and sustainable growth.</p>
                        </div>
                        
                        <div class="profile-card">
                            <img src="img/bambu/bambu_11.jpeg" alt="Image 2">
                            <p class="nama-pimpinan">Jane Smith</p>
                            <p class="jabatan-pimpinan">CFO</p>
                            <p class="desc-pimpinan">Jane Smith is responsible for managing the financial actions of the company and has over 15 years of experience in the industry.</p>
                        </div>
